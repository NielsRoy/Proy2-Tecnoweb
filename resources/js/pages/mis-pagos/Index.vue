...
// Pago de una cuota (solo la próxima). El QR es una opción más del select: si se elige, se navega a la
// página del QR; con los demás métodos se paga al instante y se muestra el comprobante.
