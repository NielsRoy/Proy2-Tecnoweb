 ...
 * servido en /storage). Eliminar es BAJA LOGICA (est=false) porque el producto puede estar
 * referenciado por ventas/compras (FK restrict). Rutas protegidas con permiso:productos,<accion>.
 */
