...
return [
    ...
    | por la clase de validación. Algunas reglas tienen varias versiones, como
    | las reglas de tamaño. Puedes ajustar cada mensaje aquí.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute proporcionado ha aparecido en una filtración de datos. Por favor, elige un valor diferente.',
    ],
    ...
    */
    ...
    | algo más legible como "correo electrónico" en lugar de "email".
    |
    */
